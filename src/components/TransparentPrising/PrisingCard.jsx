...
const PrisingCard = () => {
  return (
    <div className="main-part w-9/12 mx-auto pt-20">
      ...
      <div className="grid grid-cols-3 gap-4 mt-10">
        <div className="card1  bg-base-200 shadow-sm rounded-lg">
          <div className="card-body">
            <h2 className="text-3xl font-bold">Starter</h2>
            <p className="text-[#627382]">Perfect for getting started</p>
            <span className="text-xl mt-3 text-[#627382]">
        ...
        <div className="card2 bg-linear-to-r from-[#4F39F6] to-[#9514FA]  bg-base-200 shadow-sm rounded-lg">
          <div className="card-body">
            <div className="relative">
              <span className="badge badge-warning rounded-full absolute -top-9 right-25">
                Most Popular
              </span>
            </div>
            ...
            <span className="text-xl mt-3 text-[#627382]">
              <span className="text-2xl font-bold text-white">
                $29<p className="text-white">/month</p>
              </span>
            </span>
            ...
            <div className="mt-2">
              <button className="btn rounded-full w-full  bg-white">
                Start Pro Trial
              </button>
            </div>
          </div>
        ...
        <div className="card3  bg-base-200 shadow-sm rounded-lg">
          <div className="card-body">
